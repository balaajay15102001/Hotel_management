        ...
        //out.write(email);
         ...
         Statement stmt=con.createStatement();
          ...
          int f=0;
           ...
           if(f==0){
             out.print("<script>location=\"http://localhost:8080/hotel_management/homepage.html\";alert('Your Entered Email id is not correct');</script>");
           }
  }
  catch(Exception e){
     out.print("<script>location=\"http://localhost:8080/hotel_management/homepage.html\";alert('Your Entered Email id is not correct');</script>");
...
<h2>Update booking</h2>
 ...
 <br><br>
    ...
    <button><a href="http://localhost:8080/hotel_management/homepage.html">back to home page</a></button>
